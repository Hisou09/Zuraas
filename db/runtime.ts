...
export function ensureSchema(){
  ...
  schemaReady=(async()=>{
    const created=await db.batch([
      ...
      db.prepare("CREATE TABLE IF NOT EXISTS contents (id TEXT PRIMARY KEY,title TEXT NOT NULL,original_title TEXT NOT NULL,type TEXT NOT NULL,status TEXT NOT NULL,year INTEGER NOT NULL,episode_count INTEGER NOT NULL DEFAULT 0,rating REAL NOT NULL DEFAULT 0,genres TEXT NOT NULL DEFAULT '',image TEXT NOT NULL,banner_image TEXT NOT NULL DEFAULT '',characters TEXT NOT NULL DEFAULT '[]',description TEXT NOT NULL DEFAULT '',adult INTEGER NOT NULL DEFAULT 0,anilist_id INTEGER,created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)"),
      ...
      db.prepare("CREATE TABLE IF NOT EXISTS error_reports (id INTEGER PRIMARY KEY AUTOINCREMENT,content_id TEXT NOT NULL,chapter_number REAL NOT NULL,user_email TEXT NOT NULL,issue_type TEXT NOT NULL,details TEXT NOT NULL DEFAULT '',status TEXT NOT NULL DEFAULT 'open',created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)"),
    ...
    await addMissing("contents",{description:"TEXT NOT NULL DEFAULT ''",adult:"INTEGER NOT NULL DEFAULT 0",anilist_id:"INTEGER",banner_image:"TEXT NOT NULL DEFAULT ''",characters:"TEXT NOT NULL DEFAULT '[]'"});
